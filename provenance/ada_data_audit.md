...
- **Validation and observational alignment:** the release freezes the semantic main validation draw 007, supplementary draws 001--006 and 008--011, three SSP2-4.5 SCOREEDISTC panels, and three observation-referenced EDISTO panels. They are linked to the existing 11.9-GB metrics database audit. The observational-alignment source is the authoritative Gus July bundle `observational_alignment_v100_20260720_030533`, not the older Ada output.
